...
$msg_query = $conn->query("select * from message where member_id='$message_to' and sender_id='$message_from' or member_id='$message_from' and sender_id='$message_to' order by message_id ASC") or die(mysql_error());
