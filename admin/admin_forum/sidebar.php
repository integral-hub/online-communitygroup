 ...
 error_reporting(0);
  ...
  ?> 
   ...
   <td rowspan="2"><img src="<?php echo "../".$row['image']; ?>" width="25" height="35" class="img-square" /></td>
    <td rowspan="2">&nbsp;</td>
        	<td width="197"><?php echo $row['username']." | ".$row['access']; ?> &nbsp; <a href="admin_forum/compose_msg.php?id=<?php echo $id;  ?>" title="click to send a message to <?php echo $row['firstname']." ".$row['surname']; ?>"><i class="fa fa-comment-o"></i></a></td> 
