...
<?php  
									...
									$post_query = $conn->query("select * from post LEFT JOIN members on post.member_id = members.member_id where topic='PROGRAMMING' and post.delstatus=0 order by post_id DESC");
                                ...
                                <strong><?php 
                                 ...
                                 { 
                                    ...
                                    {
									  echo $name_row['lname']." ".$name_row['fname']." - Admin";
									}
                                   
                                    }
                                 else
                                 {  
                                    echo $post_row['firstname']." ".$post_row['surname'];
                                     }
