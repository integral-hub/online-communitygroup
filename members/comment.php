    ...
    <center>
            ...
            <div class="container-fluid">
                                ...
                                <div class="panel panel-success">
                                    <div class="panel-heading"> <textarea class="form-control" rows="2" readonly="true"><?php echo $post_row['post_title']; ?></textarea></div>
                                        ...
                                        <?php if($post_row['post_image']=="../post_images/"){  ?>
                                            <div class="col-md-12">
                                        <textarea class="form-control" rows="3" readonly="true"><?php  echo nl2br($post_row['post_content']); ?></textarea>  </div> 
                                        </div>
                                    <?php    }else{ ?>
                                          <div class="col-md-4">
                ...
                <div class="pull-left"> <h2>&nbsp;&nbsp;&nbsp;&nbsp;Threads</h2> </div> 
				                ...
				                <div class="panel-body">
                                    ...
                                    <tr> 
                                    <td> <button name="reply" class="btn btn-info pull-right">Reply</button></td>
                                    </tr>
                                    </table>
                                    </td>
                                    </tr>
                ...
                <table border="0" class="pull-right">
                <tr>
                <td><button name="comment" class="btn btn-info pull-right">Post Thread</button> </td>
                <td>&nbsp;</td>
                <td>
		...
		while ($row_query_replies_ctr = $query_replies_ctr->fetch()) 
        {
            $ctr_replies=$row_query_replies_ctr['replies_ctr']+1;
                ...
                $conn->query("insert into repz (member_id,date_replied,reply_content,comment_id,access) values ('$session_id','$date_replied','$reply_content','$comment_id','Member')");
		...
		while ($row_query_threads_ctr = $query_threads_ctr->fetch()) 
        {
            $ctr_threads=$row_query_threads_ctr['threads_ctr']+1;
                ...
                $conn->query("insert into comment (member_id,date_commented,comment_content,post_id,access) values ('$session_id','$date_comment','$comment_content','$post_idx','Member')");
