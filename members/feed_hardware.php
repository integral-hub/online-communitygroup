...
<?php  
									...
									$post_query = $conn->query("select * from post LEFT JOIN members on post.member_id = members.member_id where topic='HARDWARE' and post.delstatus=0 order by post_id DESC");
