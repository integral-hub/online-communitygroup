 ...
 <div class="container-fluid">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <td width="840">
        <font size="5">
   <a href="index.php"><img title="Administrator login" src="images/logo.png" width="60" height="60" alt="..." class="img-square"/></a> GDG Ibadan Online Community
         </font>
        </td>
        <td  >
        </td>
...
All messages are the opinions of the author and are not the views or opinions of Online Forum for GOOGLE DEVELOPERS GROUP ("GDG").  Please note that some of the boards may be intended for use by young people; please have regard to this.<br /><br />
Notwithstanding any other provision of these Terms, nothing in these Terms shall operate to exclude GDG's liability for personal injury and/or death caused by its negligence.<br /><br />
You agree that:
<ul>
<li>
...
<li>	GDG will not be liable for any errors or omissions in any postings or for any loss or damages incurred as a result of the use of any information contained in the message boards;</li>
<li>	GDG makes no guarantee or gives warranty of any kind whatsoever (whether express or implied) in relation to your use of the message board(s) or any use by any third parties; and</li>
<li>	GDG shall not be liable for any loss or damage (whether direct, indirect, consequential, financial or otherwise) arising from the use of (or in connection with) the message board(s). 
</li>
</ul>
Subject to the third paragraph of these terms in relation to GDG your sole and exclusive remedy for using the message board(s) and/or any information contained on the same is to stop using the message board(s) and/or any information contained on it/them.<br /><br />
GDG does not guarantee that the use of the message board(s) by you will be uninterrupted, error free, free from any third party interference or that the message board(s) will be free from computer viruses or other malicious software.<br /><br />
...
If you are offended by a post or topic please use the <a href="#">onlineforumforitproffandstud@yahoo.com</a> email address to give an alert to the administrator. Please do not use this facility if you simply disagree with what has been posted; if this is the case post a reply stating your opposing opinion.  When doing so do not make any personal attacks. If you disagree with another member of the boards or with a situation, state your case without attacking or insulting others, and treat others with respect.<br /><br />
			...
			<div class="modal-footer">
				<a href="join.php" type="button" class="btn btn-default"  ><i class="fa fa-times"></i> Close</a>
